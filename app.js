...
function updatesStateGifData(data) {
  // choose images.ourpreferredsizeimage
...
function windConversion(state) {
  ...
  let degrees = -12.5;
	//populate direction with cardinal directions

  const directions = [];
  for (let i = 0; i < directions.length; i++) {
    if(windDirection > degrees && windDirection < degrees + 22.5) {
...
function errorRender(state) {
  // Refactor into main render function
